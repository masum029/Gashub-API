...
{
    public class GetAllIsConfirmedOrderQuery : IRequest<IEnumerable<OrderDTO>>
    {
        
    }
    public class GetAllIsConfirmedOrderHandler : IRequestHandler<GetAllIsConfirmedOrderQuery, IEnumerable<OrderDTO>>
    {
        private readonly IUnitOfWorkDb _unitOfWorkDb;
        private readonly IMapper _mapper;
        public GetAllIsConfirmedOrderHandler(IUnitOfWorkDb unitOfWorkDb, IMapper mapper)
        {
            _unitOfWorkDb = unitOfWorkDb;
            _mapper = mapper;
        }

        public async Task<IEnumerable<OrderDTO>> Handle(GetAllIsConfirmedOrderQuery request, CancellationToken cancellationToken)
        {
            try
            {
